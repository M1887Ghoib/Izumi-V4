...
*Nama Bot :* Shoyo
*Name Owner :* Zero
*Nomor Bot :* wa.me//+18173094774${nobot}
*Nomor Owner :* wa.me//6287779335012${ownerNumber}
*Engine :* NodeJs
*Status :* Aktif
...
break
  ...
  Note : Donasi Seikhlasnya`)
		...
		conn.sendMessage(from, {text: `Ingin bertanya tanya tentang apa?`, templateButtons: owncuy, footer: `My Name : ${nameowner}`, mentions: [sender]} )
			    break
case prefix+'igowner':
 reply(`INSTAGRAM OWNER : @${insta}\nLINK : https://instagram.com/frrshyy${insta}`)
 break
